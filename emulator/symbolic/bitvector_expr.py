...
class BvExpr(Expr):
    ...
    def forceToExprCond(cond, val, size):
        return BvExpr.forceToExpr(val, size) if cond else val
    ...
    def __and__(self, other):
        if isinstance(other, BvExpr) and not other.__has_value__ and not self.__has_value__:
            ...
            if both_values:
                return BvExpr.toExpr(value & secondary, self.size)
            else:
                #secondary is a BvExpr

                #p & 0 = 0
                if value == 0:
                    return BvExpr.toExpr(0, self.size)
                ...
                return BvAndExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __or__(self, other):
        if isinstance(other, BvExpr) and not other.__has_value__ and not self.__has_value__:
            ...
            if both_values:
                ...
                #p | all-1 = all-1
                if value == self.size_mask:
                    return BvExpr.toExpr(self.size_mask, self.size)
                ...
                return BvOrExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __xor__(self, other):
        if isinstance(other, BvExpr) and not other.__has_value__ and not self.__has_value__:
            ...
            if both_values:
                ...
                return BvXorExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __invert__(self):
        if self.__has_value__:
            return BvExpr.toExpr(~self.value, self.size)
        else:
    ...
    def __rshift__(self, other):
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or other.__has_value__):
                return BvExpr.toExpr(self.value >> long(other), self.size)
            else:
                ...
                return BvShrExpr.construct(self, BvExpr.forceToExpr(other, self.size))

    def __rrshift__(self, other):
        if self.__has_value__:
            return BvExpr.toExpr(other >> self.value, self.size)
        else:
            # 0 >> p = 0
            if other == 0:
                return BvExpr.toExpr(0, self.size)
            return BvShrExpr.construct(BvExpr.forceToExpr(other, self.size), self)
    ...
    def __lshift__(self, other):
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or other.__has_value__):
                ...
                return BvShlExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __rlshift__(self, other):
        if self.__has_value__:
            ...
            if other == 0:
                return BvExpr.toExpr(0, self.size)
            return BvShlExpr.construct(BvExpr.forceToExpr(other, self.size), self)
    ...
    def __add__(self, other):
        if isinstance(other, BvExpr) and not other.__has_value__ and not self.__has_value__:
            ...
            if both_values:
                ...
                return BvAddExpr.construct(self, BvExpr.forceToExpr(other, self.size))
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or other.__has_value__):
                ...
                if self.__has_value__ and self.value == 0:
                    return BvExpr.toExpr(-other, self.size)

                return BvSubExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __rsub__(self, other):
        if self.__has_value__:
            ...
            return BvSubExpr.construct(BvExpr.forceToExpr(other, self.size), self)
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or \
                ...
                if not self.__has_value__:
                    ...
                    #1 / p = 1 (mod n)
                    if self.value == 1:
                        return BvExpr.toExpr(1, self.size)

                return BvUDivExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __rdiv__(self, other):
        if self.__has_value__:
            ...
            return BvUDivExpr.construct(BvExpr.forceToExpr(other, self.size), self)
    ...
    def __mul__(self, other):
        if isinstance(other, BvExpr) and not other.__has_value__ and not self.__has_value__:
            ...
            if both_values:
                ...
                return BvMulExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __mod__(self, other):
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or \
                ...
                return BvURemExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __rmod__(self, other):
        if self.__has_value__:
            ...
            return BvURemExpr.construct(BvExpr.forceToExpr(other, self.size), self)

    def __eq__(self, other):
        if self.__has_value__ and (not isinstance(other, BvExpr) or other.__has_value__):
            return BoolExpr.toExpr(self.value == long(other))
        else:
            return EqExpr.construct(self, BvExpr.forceToExpr(other, self.size))

    def __ne__(self, other):
        if self.__has_value__ and (not isinstance(other, BvExpr) or other.__has_value__):
            return BoolExpr.toExpr(self.value != long(other))
        else:
            return DistinctExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __gt__(self, other):
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or \
                other.__has_value__):
                return BoolExpr.toExpr(self.value > BvExpr.toExpr(long(other), self.size))
            else:
                #0 > p <=> False
                if self.__has_value__ and self.value == 0:
                    return BoolExpr.toExpr(False)

                #p > all-1 <=> False
                if not self.__has_value__ and long(other) == self.size_mask:
                    return BoolExpr.toExpr(False)

                return BvUgtExpr.construct(self, BvExpr.forceToExpr(other, self.size))
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or \
                ...
                if self.__has_value__ and self.value == self.size_mask:
                    return BoolExpr.toExpr(True)

                #p >= 0 <=> True
                if not self.__has_value__ and long(other) == 0:
                    return BoolExpr.toExpr(True)

                return BvUgeExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __lt__(self, other):
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or \
                ...
                return BvUltExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def __le__(self, other):
        ...
        if other_is_expr and not other.__has_value__ and not self.__has_value__:
            ...
            if self.__has_value__ and (not other_is_expr or \
                ...
                return BvUleExpr.construct(self, BvExpr.forceToExpr(other, self.size))
    ...
    def extract(self, end, start):
        ...
        if extract_size == self.size:
            return BoolExpr.toExpr(long(self) if self.__has_value__ else self)

        if self.__has_value__:
            return BvExpr.toExpr(self.value >> start, extract_size)
    ...
    def concat(self, other, force_expr=False):
        ...
        if self.__has_value__ and other.__has_value__:
            ...
            if force_expr:
                return BvExpr.forceToExpr(val, self.size + other.size)
            else:
                return BvExpr.toExpr(val, self.size + other.size)
    ...
    def signExtend(self, new_size):
        ...
        ret = (x ^ m) - m 
        return BvExpr.toExpr(ret, new_size)   
...
class BvAndExpr(BvExpr):
    ...
    def construct(cls, p1, p2, force_expr=False):
        ...
        p2 = BvExpr.forceToExpr(p2, p1.size)
        p1h = p1.__hash__()
        p2h = p2.__hash__()
        ...
        if (isinstance(p1, BvNotExpr) and p1.children[0].__hash__() == p2h) or \
           (isinstance(p2, BvNotExpr) and p2.children[0].__hash__() == p1h):
            return BvExpr.forceToExprCond(force_expr, 0, p1.size)
        return cls(p1, p2)
...
class BvOrExpr(BvExpr):
    ...
    def construct(cls, p1, p2, force_expr=False):
        ...
        if (isinstance(p1, BvNotExpr) and p1.children[0].__hash__() == p2h) or \
           (isinstance(p2, BvNotExpr) and p2.children[0].__hash__() == p1h):
            return BvExpr.forceToExprCond(force_expr, p1.size_mask, p1.size)
        return cls(p1, p2)
...
class BvAddExpr(BvExpr):
    ...
    def construct(cls, p1, p2, force_expr=False):
        ...
        #p + p = p * 2
        if p1.__hash__() == p2.__hash__():
            return BvExpr.forceToExprCond(force_expr, p1 * 2, p1.size)
        ...
        if isinstance(p2, BvAddExpr):
            if   p1.__hash__() == p2.children[0].__hash__():
                return BvExpr.forceToExprCond(force_expr, (p1 * 2) + p2.children[1], p1.size)
            elif p1.__hash__() == p2.children[1].__hash__():
                return BvExpr.forceToExprCond(force_expr, (p1 * 2) + p2.children[0], p1.size)
        
        #(p * q) + p = p * (q+1)
        if isinstance(p1, BvMulExpr):
            if   p1.children[0].__hash__() == p2.__hash__():
                return BvExpr.forceToExprCond(force_expr, p2 * (p1.children[1] + 1), p1.size) 
            elif p1.children[1].__hash__() == p2.__hash__():
                return BvExpr.forceToExprCond(force_expr, p2 * (p1.children[0] + 1), p1.size) 
        
        #p + (p * q) = p * (q+1)
        if isinstance(p2, BvMulExpr): 
            if   p2.children[0].__hash__() == p1.__hash__():
                return BvExpr.forceToExprCond(force_expr, p1 * (p2.children[1] + 1), p2.size) 
            elif p2.children[1].__hash__() == p1.__hash__():
                return BvExpr.forceToExprCond(force_expr, p1 * (p2.children[0] + 1), p2.size) 
...
class BvUDivExpr(BvExpr):
    ...
    def construct(p1, p2, force_expr=False):
        #p / p = 1
        if p1.__hash__() == p2.__hash__():
            return BvExpr.forceToExprCond(force_expr, 1, p1.size)
...
class BvUltExpr(BoolExpr, BvInequalityExpr):
    ...
    def construct(p1, p2, force_expr=False):
        #p < p <=> False
        if p1.__hash__() == p2.__hash__():
            return BoolExpr.forceToExprCond(force_expr, False)
...
class BvUleExpr(BoolExpr, BvInequalityExpr):
    ...
    def construct(p1, p2, force_expr=False):
        #p <= p <=> True
        if p1.__hash__() == p2.__hash__():
            return BoolExpr.forceToExprCond(force_expr, True)
