...
ins = Instruction("ADC", True, None, [ARMRegister.R0, ARMRegister.R1, Immediate(100)], eEncodingA1)
ins.id = ARMInstruction.adc_immediate
emulator.emulate(ins, dump_state=True)

ins = Instruction("ADC", True, None, [ARMRegister.R0, ARMRegister.R0], eEncodingA1)
ins.id = ARMInstruction.adc_register
emulator.emulate(ins, dump_state=True)
 
ins = Instruction("ADC", True, None, [ARMRegister.R0, ARMRegister.R0, ARMRegister.R2, RegisterShift(SRType_ASR, 4)], eEncodingA2)
